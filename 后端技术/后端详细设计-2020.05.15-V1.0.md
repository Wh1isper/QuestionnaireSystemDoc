...
- [4. 管理员模块设计](#4-管理员模块设计)
  ...
  * [4.4 核心代码及说明](#44-核心代码及说明)
    + [class AdminLoginHandler](#class-adminloginhandler)
    + [class AdminUserStateChange](#class-adminuserstatechange)
    + [class AdminQuestionnaireStateChange](#class-adminquestionnairestatechange)
    + [class AdminGetUserList](#class-admingetuserlist)
    + [class AdminGetQuestionnaireList](#class-admingetquestionnairelist)
...
### class AdminQuestionnaireStateChange
...
### class AdminGetQuestionnaireList
